        ...
        >
            ...
            <div id="aboutme-page" className='page-margins'>
                <motion.h1
                    ...
                    animate={{ boxShadow: boxShadowStyle, transition: { duration: 1, delay: 0.2 } }}
                    exit={{ opacity: 0, transition: { duration: 0.4 } }}
                    id="my-name"
                ...
                >
                    <span>Software of Choice</span> <span>Canva</span></motion.p>
                <motion.p
                    initial={{ boxShadow: "0px 0px 0px var(--color-background)" }}
                    ...
                    <span>Favourite Band</span>
                    <span>The Breeders</span>
