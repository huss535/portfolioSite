...
const Connect = ({ isLightMode, setIsLightMode }) => {
    ...
    const [emailError, setEmailError] = useState("Please enter a valid email address."); // State to track email validation error
            ...
            <div id="contact-page" className="page-margins">
                ...
                <motion.form
                    ...
                    <div className="label-textarea-section">
                        ...
                        <motion.textarea
                            initial={{ x: 1000 }}
                            animate={{ x: '25%', transition: { duration: 1, delay: 0.7, ease: "easeOut" } }}
                            required
                            id="name"
                            name="name"
                            rows={1}
                    ...
                    <div className="label-textarea-section">
                        ...
                        <motion.textarea
                            initial={{ x: 1000 }}
                            animate={{ x: '25%', transition: { duration: 1, delay: 0.9, ease: "easeOut" } }}
                            required
                            id="subject"
                            rows={1}
                            name="subject"
                        ...
                        {emailError && <span key={emailError} className={emailError ? "show" : ""} id="error-message">{emailError}</span>}
                    </div>
                    ...
                    <div className="label-textarea-section">
                        ...
                        <motion.textarea
                            initial={{ x: 1000 }}
                            animate={{ x: '25%', transition: { duration: 1, delay: 1.1, ease: "easeOut" } }}
                            required
                            id="message"
                            name="message"
                            rows={4}
